...
- React can be integrated into any application. (portion of a page or a complete page or an entire application)
...
- **Method 2 :** Using npm  
  \`npm install create-react-app -g\` ⇾ (installs the create-react-app package globally)  
  \`create-react-app project_name\` ⇾ (creates the react project)
...
- Components are re-usable.  
  (i.e. we can pass different property to component to display different information)
...
- Class component: are regular ES6 classes that extend the Component class from react library.  
  They must contain a render method that returns the HTML (JSX).
`;
