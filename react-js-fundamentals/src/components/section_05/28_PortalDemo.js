...
export const REACT_PORTAL_NOTES = `
...
- Step 3: Use the \`ReactDOM.createPortal()\` method to insert component into the portal-root node.
...
function PortalDemo() {
  return ReactDOM.createPortal(
    <div>
      <h2>Portal Demo</h2>
      <p>This component is rendered in portal-root DOM node.</p>
      &nbsp;
    </div>,
