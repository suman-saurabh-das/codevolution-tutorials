...
Library that allows us to add lightweight, non-intrusive notification messages (commonly known as toasts) to react apps with minimal configuration.

**Installation:** \`npm install react-toastify\`

**Documentation:** [react-toastify](https://fkhadra.github.io/react-toastify/introduction/)
...
- We can also chain methods like \`success(), info(), warn() or error()\` to the \`toast()\` method to customize the notification with default styles.
